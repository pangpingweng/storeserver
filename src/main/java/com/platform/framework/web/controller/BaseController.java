package com.platform.framework.web.controller;

import java.beans.PropertyEditorSupport;
import java.util.Date;
import java.util.List;

import com.platform.framework.web.domain.ResponseVo;
...
import com.platform.framework.web.page.PageDomain;
import com.platform.framework.web.page.TableDataInfo;
import com.platform.framework.web.page.TableSupport;
...
public class BaseController
{
    ...
    protected <T> ResponseVo<T> ok() {
        return new ResponseVo<>();
    }

    protected <T> ResponseVo<T> ok(T t) {
        return new ResponseVo<>(t);
    }

    protected <T> ResponseVo<T> wrong(String  msg) {
